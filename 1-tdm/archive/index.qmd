...
|---------|--------------|--------|-------------|----------|
| 9.1.0 | June 2024 | Archived | Network updates, calibration refinements | <a href="https://github.com/WFRCAnalytics/WF-TDM-Official-Releases/releases/tag/v9.1.0-official" class="download-link" onclick="return checkLicense(event)" target="_blank">↓ Download</a> |
| 9.0.2 | April 2024 | Archived | Bug fixes and minor improvements | <a href="https://github.com/WFRCAnalytics/WF-TDM-Official-Releases/releases/tag/v9.0.2-official" class="download-link" onclick="return checkLicense(event)" target="_blank">↓ Download</a> |
| 9.0.1 | February 2024 | Archived | Hot fixes for 9.0.0 | <a href="https://github.com/WFRCAnalytics/WF-TDM-Official-Releases/releases/tag/v9.0.1-official" class="download-link" onclick="return checkLicense(event)" target="_blank">↓ Download</a> |
| 9.0.0 | January 2024 | Archived | Major update: New mode choice model, updated networks | <a href="https://github.com/WFRCAnalytics/WF-TDM-Official-Releases/releases/tag/v9.0.0-official" class="download-link" onclick="return checkLicense(event)" target="_blank">↓ Download</a> |
| 8.3.2 | August 2023 | Archived | Final 8.x series release | <a href="https://github.com/WFRCAnalytics/WF-TDM-Official-Releases/releases/tag/v8.3.2-official" class="download-link" onclick="return checkLicense(event)" target="_blank">↓ Download</a> |

</div>

::: {.callout-tip}
## Need Help?
If you're unsure which version to use for your project, [contact the WFRC Analytics team](mailto:analytics@wfrc.org) for guidance.
:::
...
For questions about archived versions, [contact the WFRC Analytics team](mailto:analytics@wfrc.org).
...
[Contact us](mailto:analytics@wfrc.org) to schedule a consultation.
...
- [WFRC Main Site](https://wfrc.org){target="_blank"} - Regional planning resources
